...
<asp:UpdatePanel ID="up" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <asp:Panel ID="PnlUser" runat="server" CssClass="CSB_input_block">
            <div class="CSB_input_label">
                <csb:LabelControl ID="LabelControl2" LabelFile="WidgetRelatedObjectLists" LabelKey="LabelUser" ToolTipFile="WidgetObjectLists" ToolTipKey="TooltipUser" runat="server">
                </csb:LabelControl>
            </div>
            <div class="CSB_input_cnt">
