    ...
    <tr>
        ...
        <td align="right" valign="bottom" height="26">
            ...
            <div style="float: right;">
                <asp:HyperLink ID="LnkFind" Style="margin-top: 5px; margin-left: 5px;" CssClass="inputButton" runat="server" NavigateUrl="javascript:void(0);"><%=languageShared.GetString("CommandSearch")%></asp:HyperLink>
            </div>
        </td>
    </tr>
</table>
