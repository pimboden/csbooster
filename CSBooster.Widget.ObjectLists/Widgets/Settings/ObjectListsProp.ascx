...
<div class="CSB_input_block">
    <div class="CSB_input_label">
        <csb:LabelControl ID="Label1" LabelFile="WidgetObjectLists" LabelKey="LabelMaxNumber" ToolTipFile="WidgetObjectLists" ToolTipKey="TooltipMaxNumber" runat="server">
        </csb:LabelControl>
    </div>
...
<asp:Panel ID="PnlOrderBy" runat="server" CssClass="CSB_input_block">
    <div class="CSB_input_label">
        <csb:LabelControl ID="Label3" LabelFile="WidgetObjectLists" LabelKey="LabelOrderBy" ToolTipFile="WidgetObjectLists" ToolTipKey="TooltipOrderBy" runat="server">
        </csb:LabelControl>
    </div>
    <div class="CSB_input_cnt">
...
<div class="CSB_input_block">
    <div class="CSB_input_label">
        <csb:LabelControl ID="Label2" LabelFile="WidgetObjectLists" LabelKey="LabelPager" ToolTipFile="WidgetObjectLists" ToolTipKey="TooltipPager" runat="server">
        </csb:LabelControl>
    </div>
    <div class="CSB_input_cnt">
        <div>
...
<div class="CSB_input_block">
    <div class="CSB_input_label">
        <csb:LabelControl ID="LabelControl2" LabelFile="WidgetObjectLists" LabelKey="LabelAnonymous" ToolTipFile="WidgetObjectLists" ToolTipKey="TooltipAnonymous" runat="server">
        </csb:LabelControl>
    </div>
    <div class="CSB_input_cnt">
...
<asp:Panel ID="PnlRenderHtml" runat="server" CssClass="CSB_input_block" Visible="false">
    <div class="CSB_input_label">
        <csb:LabelControl ID="LabelControl1" LabelFile="WidgetObjectLists" LabelKey="LabelRenderHtml" ToolTipFile="WidgetObjectLists" ToolTipKey="TooltipRenderHtml" runat="server">
        </csb:LabelControl>
    </div>
    <div class="CSB_input_cnt">
