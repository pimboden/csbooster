...
namespace _4screen.CSB.DataAccess.Business
{
    ...
    public class DataObjectDocument : _4screen.CSB.DataAccess.Business.DataObject, IXmlSerializable
    {
        ...
        public DataObjectDocument(UserDataContext userDataContext)
            : base(userDataContext)
        {
            objectType = Helper.GetObjectType("Document").NumericId;
        }
        ...
        public new void Validate(AccessMode accessMode)
        {
            ...
            if (string.IsNullOrEmpty(URLDocument))
                throw new SiemeArgumentException("DataObjectDocument", "Validate", "URLDocument", "URLDocument must not be empty");
        }
        ...
        {
            return Data.DataObjectDocument.GetFullTextWhereSQL(qParas, parameters);
        }

        public override string GetOrderBySQL(Business.QuickParameters qParas, SqlParameterCollection parameters)
        {
            return Data.DataObjectDocument.GetOrderBySQL(qParas, parameters);
        }
        #endregion
        ...
        public XmlDocument GetXml()
        {
            ...
            XmlSerializer serializer = new XmlSerializer(typeof(DataObjectDocument));
