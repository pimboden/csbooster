...
namespace _4screen.CSB.DataAccess.Business
{
    public class PhotoNotes : List<PhotoNote>
    {
        ...
        public PhotoNote AddNode(Guid fromID, string from)
        {
            int intNewID = 0;
            ...
            if (objParent.userDataContext.UserID != objParent.UserID.Value)
                Event.ReportEvent(EventIdentifier.NewPhotoNote, objParent.userDataContext.UserID, objParent.ObjectID.Value);
