...
namespace _4screen.CSB.DataAccess.Business
{
    public class Partner
    {
        ...
        {
            Data.CSBooster_DataAccessDataContext dc = new Data.CSBooster_DataAccessDataContext();
        ...
        public void Update()
        {
            ...
            Data.CSBooster_DataAccessDataContext dc = new Data.CSBooster_DataAccessDataContext();
            dc.hisp_Partners_Update(PartnerID, PartnerName, CommunityID, BaseUrlXSLT, GeoServiceCalls, RESTCalls, MonthlyGeoServiceCredits, MonthlyRESTCredits, LastResetDate, MobileHeader, MobileFooter);
        }
    }
}