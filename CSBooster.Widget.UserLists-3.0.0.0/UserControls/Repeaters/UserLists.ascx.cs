...
{
    public partial class UserLists : System.Web.UI.UserControl, IReloadable, IBrowsable, IRepeater, ISettings
    {
        ...
        {
            base.OnInit(e);
            Control ctrlPagTop = this.LoadControl(string.Format("{0}/UserControls/Pager.ascx", SiteConfig.SiteVRoot));
            ...
            Control ctrlPagBot = this.LoadControl(string.Format("{0}/UserControls/Pager.ascx", SiteConfig.SiteVRoot));
        ...
        private void RestoreState()
        {
            ...
            if (!string.IsNullOrEmpty(Request.Params.Get(idPrefix + "PBGeoRadius")))
                QuickParameters.DistanceKm = int.Parse(Request.Params.Get(idPrefix + "PBGeoRadius"));
        }
        ...
        public void Reload()
        {
            ...
            this.OBJOVW.DataSource = DataObjects.Load<DataObjectUser>(QuickParameters);
            numberItems = ((DataObjectList<DataObjectUser>)this.OBJOVW.DataSource).ItemTotal;
