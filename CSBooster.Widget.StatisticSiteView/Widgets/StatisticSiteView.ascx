...
<script type="text/javascript" src="<%=VRoot %>/Library/Scripts/FlashPlayer/swfobject2.js"></script>
...
<script type="text/javascript">
    ...
    swfobject.embedSWF("<%=VRoot %>/Library/Scripts/FlashPlayer/open-flash-chart.swf", "<%=myChart.ClientID %>", "<%=ChartWidth %>", "<%=ChartHeight %>", "9.0.0", false, flashvars, params, attributes);
</script>
