...
namespace _4screen.CSB.Widget.Settings
{
    public partial class ObjectDetail : System.Web.UI.UserControl, IWidgetSettings
    {
        ...
        private void FillControls()
        {
            ...
            CbShowPager.Checked = XmlHelper.GetElementValue(xmlDocument.DocumentElement, "ShowPager", false);
        ...
        public bool Save()
        {
            try
            {
                ...
                XmlHelper.SetElementInnerText(xmlDocument.DocumentElement, "ShowPager", CbShowPager.Checked);
