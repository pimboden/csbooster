	...
	public partial class HitblWidgetInstanceIn : ActiveRecord<HitblWidgetInstanceIn>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
                ...
                TableSchema.TableColumn colvarInsShowAfterInsert = new TableSchema.TableColumn(schema);
                colvarInsShowAfterInsert.ColumnName = "INS_ShowAfterInsert";
                colvarInsShowAfterInsert.DataType = DbType.Int32;
                colvarInsShowAfterInsert.MaxLength = 0;
                colvarInsShowAfterInsert.AutoIncrement = false;
                colvarInsShowAfterInsert.IsNullable = false;
                colvarInsShowAfterInsert.IsPrimaryKey = false;
                colvarInsShowAfterInsert.IsForeignKey = false;
                colvarInsShowAfterInsert.IsReadOnly = false;
                colvarInsShowAfterInsert.DefaultSetting = @"";
                colvarInsShowAfterInsert.ForeignKeyTableName = "";
				schema.Columns.Add(colvarInsShowAfterInsert);
        ...
        [XmlAttribute("InsShowAfterInsert")]
		[Bindable(true)]
        public int InsShowAfterInsert 
		{
            get { return GetColumnValue<int>(Columns.InsShowAfterInsert); }
            set { SetColumnValue(Columns.InsShowAfterInsert, value); }
		}
		...
		/// </summary>
		public static void Insert(Guid varInsId,Guid varWdgId,Guid varInsPagId,int varInsColumnNo,int varInsOrderNo,string varInsXmlStateData,DateTime varInsCreatedDate,DateTime varInsLastUpdate,int varInsShowAfterInsert,Guid? varWtpId,bool varInsIsFixed,bool varInsHideIfNoContent,string varInsViewRoles,Guid? varInsOutputTemplate,int? varInsHeadingTag)
		{
            ...
            item.InsShowAfterInsert = varInsShowAfterInsert;
        ...
        public static TableSchema.TableColumn InsShowAfterInsertColumn
        {
		...
		public struct Columns
		{
             ...
             public static string InsShowAfterInsert = @"INS_ShowAfterInsert";
