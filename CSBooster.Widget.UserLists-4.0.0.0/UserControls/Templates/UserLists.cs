...
namespace _4screen.CSB.Widget.UserControls.Templates
{
    public partial class UserLists : System.Web.UI.UserControl, IDataObjectWorker
    {
        ...
        protected string UserDetailURL
        {
            get
            {
                return  Helper.GetDetailLink(2, DataObjectUser.Nickname);
            }
        }
        ...
        protected string UserPrimaryColorLargeURL
        {
            get
            {
                return string.Format("{0}{1}.png",  "/Library/Images/User/lg/pc/", DataObjectUser.PrimaryColor);
            }
        }
        ...
        protected string UserSecondaryColorLargeURL
        {
            get
            {
                return string.Format("{0}{1}.png",  "/Library/Images/User/lg/sc/", DataObjectUser.SecondaryColor);
            }
        }
        ...
        protected string UserPrimaryColorSmallURL
        {
            get
            {
                return string.Format("{0}{1}.png", "/Library/Images/User/sm/pc/", DataObjectUser.PrimaryColor);
            }
        }
        ...
        protected string UserSecondaryColorSmallURL
        {
            get
            {
                return string.Format("{0}{1}.png", "/Library/Images/User/sm/sc/", DataObjectUser.SecondaryColor);
            }
        }
