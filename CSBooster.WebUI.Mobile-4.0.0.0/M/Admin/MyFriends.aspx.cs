...
{
    public partial class MyFriends : System.Web.UI.Page, IReloadable, IBrowsable
    {
        ...
        public void Reload()
        {
            this.myFriends.Reload();
        }

        public int GetNumberItems()
        {
            return this.myFriends.GetNumberItems();
        }

        public void SetCurrentPage(int currentPage)
        {
            this.myFriends.SetCurrentPage(currentPage);
        }
    }
}