...
{
    public partial class DetailsVideo : System.Web.UI.UserControl, IDataObjectWorker
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataObjectVideo video = (DataObjectVideo)DataObject;

            string imageUrl = DataObject.GetImage(PictureVersion.M, false);
            lnkVideo.Text = string.Format("<img src='{0}{1}' />", SiteConfig.MediaDomainName, imageUrl);
            lnkVideo.NavigateUrl = string.Format("{0}{1}", Helper.GetVideoBaseURL(), video.GetLocation(VideoFormat.Mp4, VideoVersion.None));
            lnkVideo.ID = null;
