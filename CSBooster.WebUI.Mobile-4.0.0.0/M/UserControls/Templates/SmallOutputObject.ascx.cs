...
{
    public partial class SmallOutputObject : System.Web.UI.UserControl, IDataObjectWorker
    {
        ...
        {
            lnkDetail.NavigateUrl = Helper.GetMobileDetailLink(DataObject.ObjectType, DataObject.ObjectID.ToString());
