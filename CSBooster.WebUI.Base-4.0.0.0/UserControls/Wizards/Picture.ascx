<%@ Control Language="C#" AutoEventWireup="true" Inherits="_4screen.CSB.WebUI.UserControls.Wizards.Picture" CodeBehind="Picture.ascx.cs" %>
...
<div class="inputBlock">
    ...
    <div class="inputBlockContent">
        ...
        <div class="inputBlockImage">
            <asp:HyperLink ID="LnkImage" CssClass="inputButton" NavigateUrl="javascript:void(0)" runat="server"><%=languageShared.GetString("CommandCrop") %></asp:HyperLink>
        </div>
    </div>
</div>
<div class="inputBlock">
