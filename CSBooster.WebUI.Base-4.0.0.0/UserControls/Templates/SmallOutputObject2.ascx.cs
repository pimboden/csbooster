...
{
    public partial class SmallOutputObject2 : System.Web.UI.UserControl, IDataObjectWorker, IFolderParameters, ISettings
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            LnkAutor.NavigateUrl = Helper.GetDetailLink("User", DataObject.UserID.Value.ToString(), string.IsNullOrEmpty(FolderParameters)) + FolderParameters;
