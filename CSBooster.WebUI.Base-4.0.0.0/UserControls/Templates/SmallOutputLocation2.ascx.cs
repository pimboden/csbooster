...
{
    public partial class SmallOutputLocation2 : System.Web.UI.UserControl, IDataObjectWorker, ISettings
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(DataObject.GetImage(PictureVersion.S, false)))
            {
                ...
                Img.ToolTip = DataObject.Description.StripHTMLTags().CropString(200);
            }
